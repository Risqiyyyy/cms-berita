...
@section('content')
    <div class="grid lg:grid-cols-3 gap-6">
                    ...
                    <div class="grid lg:grid-cols-4 gap-6">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div class="">
                                ...
                                <span class="text-sm">Daily Click</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-span-1">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Post Activities</h6>
                </div>
                        ...
                        <div class="p-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-grow truncate">
                                    <div class="font-medium text-gray-900 dark:text-gray-300">Judul</div>
                                </div>
                                <div class="px-3 py-1 md:block hidden rounded text-xs font-small">Kategori</div>
                            </div>
                        </div>
